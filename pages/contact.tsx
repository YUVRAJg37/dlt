      ...
      <div className='drop-shadow-md transition-all'>
        <div className="p-6 mr-2 m-5 bg-gray-100 sm:rounded-lg">
          ...
          <div className="flex items-center mt-8 text-gray-600">
            <svg fill="#ca8a04" stroke="white" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" viewBox="0 0 24 24" className="w-8 h-8 text-gray-500">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <div className="ml-4 text-md tracking-wide font-semibold w-40">
              Hinna Henna Inc, New Delhi, New Delhi,
              222202
            </div>
          </div>
